...
const GlobalStyles = () => (
  <style>{`
    ...
    .zone-dark .backdrop-blur-sm,
    .zone-dark .backdrop-blur-md {
      backdrop-filter: none;
    }

    .zone-dark .odyssey-card {
      backdrop-filter: none;
    }
  `}</style>
);
...
const SectionHeader = ({ eyebrow, title, description, descriptionTone = 'dark' }) => {
  ...
  return (
    <div className="text-center mb-12">
      ...
      {description && (
        <p className={`max-w-3xl mx-auto text-lg ${descriptionClass}`}>
          {description}
        </p>
      )}
    </div>
...
export default function App() {
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        body.dataset.zone = isDark ? 'dark' : 'light';
      },
  ...
  return (
    <div className="min-h-screen relative selection:bg-[var(--color-bronze-light)] selection:text-white">
      ...
      {/* --- HEADER --- */}
      <header className="site-header fixed top-0 left-0 right-0 z-50 bg-[var(--light-bg-body)]/80 backdrop-blur-md border-b border-[var(--light-border-subtle)]">
      ...
      <section id="root" className="zone-dark bg-[#0F172A] py-24">
      ...
      {/* --- COSMOLOGY SECTION --- */}
      <section id="cosmology" className="zone-dark bg-[#0F172A] pb-24">
        <div className="max-w-3xl mx-auto px-6">
          <SectionHeader
      ...
      <section id="synthesis" className="zone-dark bg-[#1E293B] py-24">
      ...
      <section id="transmute" className="zone-dark bg-[#020617] min-h-screen flex flex-col items-center justify-center text-center relative overflow-hidden py-24">
        {/* Ambient Glow */}

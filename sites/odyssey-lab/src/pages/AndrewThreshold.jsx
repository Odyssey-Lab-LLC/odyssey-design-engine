...
export default function AndrewThreshold() {
  ...
  useEffect(() => {
    ...
    if (narrativeZoneRef.current) {
      zoneObserver.observe(narrativeZoneRef.current);
    }
  ...
  return (
    <>
      ...
      <section className="lens-container" id="hero">
      ...
      <main className="content-block" id="narrative-zone" ref={narrativeZoneRef}>
        ...
        <div className="proof-point-wrapper">
          ...
          <a href="#" className="proof-point-link">View TBC Research →</a>
        </div>
